...
#     python misEvaluator.py --node_counts 5 10 15 20 25 30 --base_dir test_generated_graphs --output_dir test_mis_results_grouped_v3
#     python misEvaluator.py --node_counts 10 15 20 25 30 --base_dir generated_graphs --output_dir mis_results_grouped
#     python misEvaluator.py --node_counts 35 40 --base_dir generated_graphs --output_dir mis_results_grouped_v3
#     python misEvaluator.py --node_counts 45 --base_dir generated_graphs --output_dir mis_results_grouped_v3
#     python misEvaluator.py --node_counts 50 --base_dir generated_graphs --output_dir mis_results_grouped_v3
...
#     python misEvaluator.py --node_counts 70 --base_dir generated_graphs --output_dir mis_results_grouped_v3
# python misEvaluator.py --node_counts 60 --base_dir test_generated_graphs --output_dir test_mis_results_grouped_v3
