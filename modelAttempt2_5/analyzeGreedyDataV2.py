...
Usage:
    python analyzeGreedyDataV2.py --csv_in mis_greedy_results.csv --img_out temp_images/rmse_heatmaps_v2.png
...
def main():
    ...
    # Expected columns in the CSV produced by the evaluation script.
    required_columns = [
        "true_mis",
    ...
    # Compute the RMSE for each group for each metric.
    metrics_heatmaps = {}
    ...
    # Determine global vmin and vmax across all heatmaps for a consistent color scale.
