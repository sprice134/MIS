...
if __name__ == "__main__":
    ...
    epislons = [0.025, 0.05, 0.1, 0.15, 0.175, 0.2, 0.225, 0.25]
    num_trials = 5  # Adjust as needed; set to 1 for brevity here
    base_seed = 42
    csv_filename = "bipartite_experiment_results_epislons.csv"
    
    # If file exists, remove it to start fresh (or you can comment this out if you wish to append)
