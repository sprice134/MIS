#!/bin/bash
#SBATCH --job-name=85000                 # Job name
#SBATCH --cpus-per-task=14              # Number of CPU cores
...
python /home/sprice/MIS/_reichman/bipartite/oracleBipartiteExperimentCLtemp3.py 85000 15
